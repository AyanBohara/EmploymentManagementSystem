...
const TaskList = ({ data }) => {
    return (
        <div id='tasklist' className='overflow-x-auto mt-10 h-[55%] w-full py-5 rounded flex items-center justify-start gap-5 flex-nowrap'>
            ...
            <div className='flex-shrink-0 h-full w-[300px] bg-red-400 rounded-xl p-5 '>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <h4 className='text-sm'>5 Nov 2024</h4>
                </div>

                <h2 className='mt-5 text-2xl font-semibold'>Make a youtube video</h2>
                <p className='text-sm mt-2'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi itaque consequuntur quis sunt eos provident molestiae, maxime ad.
                </p>
